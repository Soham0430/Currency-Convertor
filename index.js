...
const fromCurr = document.querySelector("select[name='Currancy_1']");
const toCurr = document.querySelector("select[name='Currancy_2']");
...
const ChangeFlag=(element)=>{
   let newFlag=element.value;
   let countrycode=countryList[newFlag];
...
btn.addEventListener("click" , async (evt)=>{
    ...
    exchangedata.innerText = `${amt} ${fromCurr.value} = ${finalAmount.toFixed(3)} ${toCurr.value}`;
